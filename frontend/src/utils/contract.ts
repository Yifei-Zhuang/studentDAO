...
// 修改地址为部署的合约地址
const StudentSocietyAddress = Addresses.student
const StudentABI = StudentSociety.abi
...
// 获取合约实例
const studentContract = new web3.eth.Contract(StudentABI, StudentSocietyAddress);
...
// 导出web3实例和其它部署的合约
export {web3, studentContract, myERC20Contract,myERC721Contract}